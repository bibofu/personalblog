  ...
  routes: [
    {
      ...
      children: [
        ...
        },
        {
          ...
          meta: {
            title: '博文列表 | Bibo的个人博客 | 一个努力成长中的Java后端程序猿'
          }
        },
        {
          ...
          meta: {
            title: '博文列表 | BiBo的个人博客 | 一个努力成长中的程序猿'
          }
        },
        {
          ...
          meta: {
            title: '博文搜索 | BiBo的个人博客 | 一个努力成长中的程序猿'
          }
        },
        {
        ...
        },
        {
          ...
          meta: {
            title: '阅读 | BiBo的个人博客 | 一个努力成长中的程序猿'
          }
        },
        {
        ...
        },
        {
          ...
          meta: {
            title: '时间轴 | BiBo的个人博客 | 一个努力成长中的程序猿'
          }
        }
      ]
    }
